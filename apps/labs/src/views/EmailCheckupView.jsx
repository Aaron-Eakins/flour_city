        ...
        <div className="pt-40 pb-24 bg-[#F2F1EF] min-h-screen animate-in fade-in duration-700 text-[#1A1B1E]">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <header className="mb-20 space-y-12 text-left">
                    ...
                    <DimensionedHeader line1="FREE EMAIL" line2="CHECKUP." layerHt="SPF·DKIM" partWd="DMARC·MX" variant="light" />
                    <p className="text-gray-500 max-w-2xl font-medium leading-relaxed text-lg text-left">
                        Give me your domain and I'll check the things that quietly send your email to spam: SPF, DKIM, DMARC, MX records, and whether you're on any blacklists. I'll email you what's wrong and how to fix it. The first look is free; if you want me to fix it, we'll scope that from there.
                    </p>
                </header>
