    ...
    <div className="animate-in fade-in duration-700">
        ...
        <section className="py-24 bg-[#F2F1EF] text-[#1A1B1E]">
            ...
            <section className="grid md:grid-cols-3 gap-8 mb-24">
                ...
                <div onClick={() => setView('email')} className="bg-gradient-to-br from-[#2C3E50] to-[#1A1B1E] p-8 rounded-sm shadow-2xl border border-white/10 text-[#F2F1EF] space-y-4 hover:scale-[1.03] hover:shadow-3xl transition-all duration-300 cursor-pointer group">
                ...
                {/* 3D Printing */}
                <div onClick={() => setView('printing')} className="bg-gradient-to-br from-[#2C3E50] to-[#1A1B1E] p-8 rounded-sm shadow-2xl border border-white/10 text-[#F2F1EF] space-y-4 hover:scale-[1.03] hover:shadow-3xl transition-all duration-300 cursor-pointer group">
                ...
                {/* Web & Site Work */}
                <div onClick={() => setView('web-design')} className="bg-gradient-to-br from-[#2C3E50] to-[#1A1B1E] p-8 rounded-sm shadow-2xl border border-white/10 text-[#F2F1EF] space-y-4 hover:scale-[1.03] hover:shadow-3xl transition-all duration-300 cursor-pointer group">
