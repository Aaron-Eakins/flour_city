// Characterization tests for @flour-city/email-core. Same corpus + expectations as
// the email-parser CLI suite — this is the behavioral spec every consumer must match.
// Pure: reads .eml text and runs it straight through the shared pipeline (no loader).
...
import { splitHeaders, unfoldHeaders, parseReceivedChain } from '../src/parser.js';
