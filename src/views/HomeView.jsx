        ...
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#1A1B1E]">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center text-left">
                <div className="space-y-8">
                    ...
                    <p className="text-gray-400 text-lg max-w-md leading-relaxed border-l-2 border-[#D4A017] pl-6 font-medium">Boutique additive manufacturing for engineers and innovators. We bridge digital intent and physical reality with expert human oversight.</p>
        ...
        <section className="bg-[#2C3E50] py-32 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center text-[#F2F1EF]">
                ...
                <div className="space-y-8 text-left">
                    <div className="inline-block px-4 py-1 border border-[#D4A017] text-[#D4A017] text-[10px] font-black tracking-[0.4em] uppercase">Our Story</div>
                    ...
                    <p className="text-gray-300 text-lg font-medium italic leading-relaxed">"Continuing a two-hundred-year-old conversation about how things are made in the Flour City."</p>
