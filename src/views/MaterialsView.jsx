        ...
        <div className="max-w-7xl mx-auto px-6 text-[#1A1B1E] text-left">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-left">
                <div className="p-10 bg-[#2C3E50] text-[#F2F1EF] rounded-sm shadow-2xl relative overflow-hidden group">
                    <Wrench className="absolute -top-4 -right-4 w-40 h-40 text-white/5 opacity-20" />
                    <div className="relative z-10 space-y-8">
                        ...
                        <p className="text-slate-400 font-medium leading-relaxed">The industry standard for aesthetic precision. Ideal for high-detail models and prototypes.</p>
                        <div className="grid grid-cols-2 gap-6 border-t border-white/10 pt-8 font-bold text-xs uppercase tracking-widest">
                            <div className="space-y-1"><p className="text-[#D4A017]">Variates</p><p>Matte, Silk, Std</p></div>
                ...
                <div className="p-10 bg-[#EAE8E4] border border-gray-300 rounded-sm shadow-2xl relative overflow-hidden group text-[#1A1B1E]">
                    <ShieldCheck className="absolute -top-4 -right-4 w-40 h-40 text-[#1A1B1E]/5 opacity-20" />
                    <div className="relative z-10 space-y-8 text-left">
                        ...
                        <p className="text-gray-500 font-medium leading-relaxed">Industrial toughness for mechanical parts. Heat resistant and impact ready.</p>
                        <div className="grid grid-cols-2 gap-6 border-t border-gray-300 pt-8 font-bold text-xs uppercase tracking-widest text-[#1A1B1E]">
                            <div className="space-y-1"><p className="text-[#4A6982]">Resilience</p><p>Impact/Chem</p></div>
